...
<head>
	<meta charset="UTF-8">
    <title>PDO Transaction (Check Balance)</title>
	<link href="../css/style.css" rel="stylesheet" type="text/css" />
</head>
<body>
	<?php require_once '../includes/config.php'; ?>
	<h1>PDO Transactions (Check Balance)</h1>
	<?php
	    ...
	    if (!$pay->rowCount() || !$receive->rowCount()):
	    	...
	    	if ($balance < 0):
	            $db->rollBack();
	            $transactionError = "Transaction failed: insufficient funds in $payer's account.";
	        else:
		        $db->commit();
		    endif;
	    endif;
